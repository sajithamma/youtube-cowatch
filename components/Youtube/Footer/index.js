...
class Footer extends Component{
  ...
  render(){
      ...
      <div className={styles.icon}>
            ...
            <>
                  ...
                  <>
                    ...
                    <div><a  onClick={this.muteLocalVideo} href="#cam" title="Turn On Camera"><img src="/cam-on.png"/></a></div> 
                  ...
                  <>
                    ...
                    <div><a  onClick={this.unMuteLocalVideo} href="#cam" title="Turn Off Camera"><img src="/cam-off.png"/></a></div> 
                  ...
                  { !this.state.disableLocalAudio &&
                      ...
                      <div><a href="#" onClick={this.muteLocalAudio} title="Turn On Mic" ><img src="/mic-on.png"/></a></div>
                      </>
                  }
                  ...
                  { this.state.disableLocalAudio &&
                      ...
                      <div><a href="#" onClick={this.unMuteLocalAudio} title="Turn Off Mic" ><img src="/mic-off.png"/></a></div> 

                      </>
                  }


                   <div><a href="#" onClick={this.leaveChannel} title="Leave" ><img src="/leave.png"/></a></div> 
          ...
          <div className={styles.iconSet}>
               ...
               <>
                  <div ><a onClick={this.sepiaOff}  href="#sepia" ><img src="/sepiaon.png"/></a></div> 
                </>
               }

               { this.hideSepia === false &&   !this.state.sepia && 
               <>
                  <div ><a onClick={this.sepiaOn}  href="#sepia" ><img src="/sepiaoff.png"/></a></div> 
               </>
               }

              <div ><a onClick={this.chatDisplay}  href="#chat" ><img src="/chat.png"/></a></div> 
              
              <div><a href="#emoji" onClick={this.emojiDisplay}><img src="/emoji.png"/></a></div> 
    ...
    {this.state.emojiAnimation ? <div className={styles.emojiAnimdiv}> <img className={styles.emojiAnimation} src={this.state.image}/> 
    <img className={styles.emojiAnimation2} src={this.state.image}/>
    <img className={styles.emojiAnimation3} src={this.state.image}/>
    </div>: null}
