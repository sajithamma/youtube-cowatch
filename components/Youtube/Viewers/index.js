                            ...
                            <div className={styles.videoblock}>
                                ...
                                <div className={styles.sidebar} style={{ display: this.state.show ? "block" : "none" }}>
                                    ...
                                    {this.state.streamVideo &&
                                        <>
                                            <div className={styles.icons}>
                                                <a href="#" onClick={this.disableVideoStream} ><Image alt="viewon" src="/view-on.png" /></a>
                                            </div>
                                        </>
                                    }
                                    ...
                                    {!this.state.streamVideo &&
                                        <>
                                            <div className={styles.icons}>
                                                <a href="#" onClick={this.enableVideoStream}><Image alt="viewoff" src="/view-off.png" /></a>
                                            </div>
                                        </>
                                    }
                                    ...
                                    {this.state.streamAudio &&
                                        <>
                                            <div className={styles.icons}>
                                                <a href="#" onClick={this.disableAudioStream} ><Image alt="speakeron" src="/speaker-on.png" /></a>
                                            </div>
                                        </>
                                    }
                                    ...
                                    {!this.state.streamAudio &&
                                        <>
                                            <div className={styles.icons}>
                                                <a href="#" onClick={this.enableAudioStream} ><Image alt="speakeroff" src="/speaker-off.png" /></a>
                                            </div>
                                        </>
                                    }
